...
btcPrice=$(curl -X 'GET' 'https://api.coingecko.com/api/v3/simple/price?ids=bitcoin&vs_currencies=aud' -H 'accept: application/json' | jq .bitcoin.aud)
...
echo '🗠 BTC➔$'$btcPrice' ADA➔$'$adaPrice' BNB➔$'$bnbPrice''
